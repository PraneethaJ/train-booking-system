...
namespace TravelBookingSystem.Services
{
    public class TravelerServices
    {
        ...
        public async Task<Traveler> GetAsync(string id) =>
            await _travelerCollection.Find(t => t.Id == id).FirstOrDefaultAsync();
        ...
        //update traveler
        public async Task UpdateAsync(string id, Traveler updateTraveler) =>
            await _travelerCollection.ReplaceOneAsync(t => t.Id == id, updateTraveler);

        //delete traveler
        public async Task RemoveAsync(string id) =>
            await _travelerCollection.DeleteOneAsync(t => t.Id == id);

        //check traveler NIC
        public async Task<Traveler> CheckTravelerByNIC(string nic) => await _travelerCollection.Find(t => t.NIC == nic).FirstOrDefaultAsync();
    }
}
